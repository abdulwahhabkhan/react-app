...
const routes = [
    {path: '/app/dashboard', component : Dashboard, meta: {title: 'Dashboard'+ APP_TITLE}, noSideBar: true },
    {path: ["/app/projects", "/app/projects/current", "/app/projects/completed"], component : Projects, meta: {title: 'Projects List'+ APP_TITLE}},
    //{path: "/projects", component : Projects, meta: {title: 'Projects List'+ APP_TITLE}, children: true},
    {path: '/app/projects/:id', component : ProjectDetail, children:true, meta: {title: 'Projects Detail'+ APP_TITLE}},
